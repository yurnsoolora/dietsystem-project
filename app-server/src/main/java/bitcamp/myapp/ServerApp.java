...
public class ServerApp {
  ...
  private void prepareMenu() {
    ...
    memberMenu.add(new Menu("회원등록", new MemberAddListener(memberDao, sqlSessionFactory)));
    ...
    memberMenu.add(new Menu("회원변경", new MemberUpdateListener(memberDao, sqlSessionFactory)));
    memberMenu.add(new Menu("회원삭제", new MemberDeleteListener(memberDao, sqlSessionFactory)));
    mainMenu.add(memberMenu);

    MenuGroup boardMenu = new MenuGroup("식단관리");
    boardMenu.add(new Menu("식단등록", new BoardAddListener(boardDao, sqlSessionFactory)));
    boardMenu.add(new Menu("식단목록", new BoardListListener(boardDao)));
    boardMenu.add(new Menu("식단조회", new BoardDetailListener(boardDao, sqlSessionFactory)));
    boardMenu.add(new Menu("식단변경", new BoardUpdateListener(boardDao, sqlSessionFactory)));
    boardMenu.add(new Menu("식단삭제", new BoardDeleteListener(boardDao, sqlSessionFactory)));
